...
class WebSearchInput(BaseModel):
    ...
    message: str = Field(..., description="The search message")

class WebSearchTool(BaseTool):
    name: str = "Web Search"
    description: str = "Search the web for AI news and returns the top result"
    args_schema: Type[BaseModel] = WebSearchInput

    def _run(self, message: str) -> str:
        logger.info(f"Executing web search for AI news")
        try:
            params = {
                "engine": "google",
                "q": message,
